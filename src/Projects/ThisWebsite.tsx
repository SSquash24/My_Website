    ...
    return (
        <div className="Project ProjPage">
            ...
            <div className="block purple">
                ...
                <div className='list'>
                    <b>Separation:</b> If any other boids are too close, the boid will move away from them. This rule
                    also tells the boids to turn away from walls.<br/>
                ...
                <p>In addition, I added a few extra rules for increased depth. In order to accommodate these rules boids
                    now have a colour, and different coloured boids may follow different rules</p>
                <div className='list'>
